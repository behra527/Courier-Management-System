...
<div class="banner">
    ...
    <button><a href="add_emp.php" >ADD</a></button>
...
<td><a href="edit_emp.php?uid=<?php echo $row['id']; ?>"><input type="button" value="EDIT" id="green"></a>
<a href="delete_emp.php?uid=<?php echo $row['id']; ?>"><input type="button" value="DELETE" ></a></td>
</tr>
<?php
}}
?>
